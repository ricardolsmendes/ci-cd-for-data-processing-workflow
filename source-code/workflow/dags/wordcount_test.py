...
with models.DAG('wordcount_test',
    ...
    download_result_one = GoogleCloudStorageDownloadOperator(
        task_id=f'{download_task_prefix}_1',
        bucket=output_bucket_name,
        object=f'{output_prefix}-00000-of-00003',
        store_to_xcom_key='res_str_1',
        start_date=yesterday)

    download_result_two = GoogleCloudStorageDownloadOperator(
        task_id=f'{download_task_prefix}_2',
        bucket=output_bucket_name,
        object=f'{output_prefix}-00001-of-00003',
        store_to_xcom_key='res_str_2',
        start_date=yesterday)

    download_result_three = GoogleCloudStorageDownloadOperator(
        task_id=f'{download_task_prefix}_3',
        bucket=output_bucket_name,
        object=f'{output_prefix}-00002-of-00003',
